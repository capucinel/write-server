...
INSERT INTO writings (title, media_url, content, id_theme)
...
Certaines recettes modernes précuisent les pommes de terre dans le lait. Toutefois, le fondant des pommes de terre provient avant tout d'une cuisson lente au four (plus de 90 minutes) et de l'absorption de la crème par les pommes de terre. Une variante existe en remplaçant le lait ou la crème par du bouillon (de volaille de préférence) et en ajoutant des feuilles de laurier.", 6);
...
INSERT INTO writings (title, media_url, content, id_theme)
VALUES
("sujet 1","image", "texte1" , 6),
("sujet 2","image", "texte2" , 6),
("sujet 3","image", "texte3" , 6),
("sujet 4","image", "texte4" , 6),
("sujet 5","image", "texte5" , 6),
("sujet 6","image", "texte6" , 6),
("sujet 7","image", "texte7" , 6);
